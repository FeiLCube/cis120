...
public class Pixel implements Comparable<Pixel> {
    ...
    public int distance(Pixel px) {
        ...
        int sum = 0;
        sum += Math.abs(this.red - px.red);
        sum += Math.abs(this.green - px.green);
        sum += Math.abs(this.blue - px.blue);
        return sum;
    }
    ...
    public boolean equals(Pixel px) {
        return ((this.red == px.red) && (this.green == px.green) && (this.blue == px.blue));
    }
